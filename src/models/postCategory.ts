...
const ThemeFilesModel: PostCategoryModelType = {
    ...
    effects: {
        *fetchCategory({ payload: { categoryId } }, { call, put }) {
        ...
        *fetchData({ payload: { categoryId, page = 1, pageSize = 10 } }, { call, put }) {
            ...
            const listRes = yield call(getPosts, page, pageSize, {
            ...
            const hotRes = yield call(getPosts, page, pageSize, {
                ids: [Number(categoryId)],
                hot: 1
            })
